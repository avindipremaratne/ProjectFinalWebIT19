...
<div id="heading"> TELEVISION  
  ...
  <form id='form2' name='form2' method='post' action='cmbkitchenappliances.php'>
   <div id="apDiv1">
     <select name="cmb" id="cmb" class="combo">
       <option>Select Category</option>
       <option>Blenders</option>
       <option>Rice Cooker</option>
       <option>Toasters</option>
       <option>Electric Ovens</option>
       <option>Gas Cookers</option>
     </select>
   </div>
<div id="apDiv2">
  ...
  $result=mysqli_query($con,"SELECT * FROM stocks where Category='KitchenAppliances'");
if(!$result)
{
