...
<div id="apDiv5555" >
  <?php
  $x = 1;
  echo "<table border=3 width=100% height=100%>";
		do {
			echo "<tr>";
//   echo "<td>". include("Items.php");
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
				echo "<td>";
						echo "<div id=dimg > Image </div>";
				echo "<td>";
												
							echo "<div id='ddesc'> Description </div>";
							
						
						echo "<input type='submit' name='btnbuy' id='btnbuy' value='Buy' class='btnbuy'/>"  ;
