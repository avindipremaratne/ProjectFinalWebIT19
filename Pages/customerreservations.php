...
<div id="apDiv6">
  <center>
    <font color="#FFFFFF" size="+4" face="Trebuchet MS, Arial, Helvetica, sans-serif">PREMCO CUSTOMER RESERVATIONS</font>
  </center>
</div>
...
echo "<td><input name='button[3]' id='button[3]'type='submit' value='Reservations' / >";
?>
</form>
